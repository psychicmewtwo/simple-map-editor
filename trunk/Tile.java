...
public class Tile
{
	...
	public Tile(int number, int type, String name, Image i)
	{
		this.image = i;
		this.type = type;
		this.number = number;
		...
		System.out.println("Warning: No path known for the image used by this tile");
		//System.out.println(imageWidth);
	}
	
	public Tile(int number, int type, String name, Image i, String path)
	{
		this.image = i;
		this.type = type;
		this.number = number;
	...
	/**
	 * pretty much creates a shallow copy of the given tile.
	...
	public Tile(Tile t)
	{
		this(t.getNumber(), t.getType(), t.getName(), t.getImage(), t.getImageLocation());
		System.out.println("WARNING: Creating shallow copy of tile");
	}
	...
	/**
	 * Compare tiles. if the image, name, number and type are the same,
	...
	void initEffectImage()
	{
		...
		g.setRenderingHint(RenderingHints.KEY_RENDERING, RenderingHints.VALUE_RENDER_QUALITY); //lame
